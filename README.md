...
This resume is based off of Bryce Tsuyuki's resume, which is in turn based on the original Awesome-CV template found [here](https://github.com/posquit0/Awesome-CV). The original README follows below. All credit to the orignal authors, but I have made a few modifications to make this resume more tailored to my preferences (i.e. reduced spacing, different bolding for the name at the top).
